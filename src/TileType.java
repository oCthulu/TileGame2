...
public class TileType extends AbstractTileType<TileType>{
    //all static fields relating to the collision lookup are at the bottom of the class
...
//        }
    ...
    private static final Triangle[][][] collisionLookup = {
            {
                    //0b0000
                    {new Triangle(O_CC, O_TL, O_TR)}, //top
                    {new Triangle(O_CC, O_TR, O_BR)}, //right
                    {new Triangle(O_CC, O_BR, O_BL)}, //bottom
                    {new Triangle(O_CC, O_BL, O_TL)}  //left
            },
            {
                    //0b0001
                    {},
